    ...
    <Grid item xs={8} sm={6} className={classes.container}>
      <Box component="form" onChange={onChange}>
        <FormControl fullWidth variant="outlined" margin="normal">
          ...
          <TextField fullWidth name="name" size="small" value={form.name} />
        </FormControl>
        <FormControl fullWidth variant="outlined" margin="normal">
          <InputLabel
            shrink
        ...
        <FormControl fullWidth variant="outlined" margin="normal">
          ...
          <TextField fullWidth name="phone" size="small" value={form.phone} />
        </FormControl>
        <FormControl fullWidth variant="outlined" margin="normal">
          <InputLabel
            shrink
      ...
      <div className={classes.btnContainer}>
        ...
        <Button variant="contained" onClick={onSave} disabled={!edit}>
          Save
        </Button>
      </div>
    </Grid>
